...
-- 给列添加index，之后就能节省时间，无须sequential scan遍历所有行
...
FROM '/Users/xiaofan/Downloads/practical-sql-master/Chapter_08/pls_fy2014_pupld14a.csv'
...
FROM '/Users/xiaofan/Downloads/practical-sql-master/Chapter_08/pls_fy2009_pupld09a.csv'
WITH (FORMAT CSV, HEADER);


-- 行的计数
-- SELECT count(*)
-- FROM pls_fy2014_pupld14a; --9305
-- 无重复地计数
SELECT count(DISTINCT libname)
FROM pls_fy2014_pupld14a; --8515

-- 指定列里有多少行的计数
SELECT count(salaries)
FROM pls_fy2014_pupld14a; --5283
...
-- GROUP BY city, stabr
-- ORDER BY city, stabr;
SELECT city, stabr, count(*) --✳️含null
FROM pls_fy2014_pupld14a
GROUP BY city, stabr --缺省group by则报错
ORDER BY count(*) DESC; --按count返回

SELECT stabr, stataddr, count(*)
FROM pls_fy2014_pupld14a
GROUP BY stabr, stataddr
ORDER BY stabr ASC, count(*) DESC; --组合有条件地返回
...
-- 返回4列，对state使用group by，加总，计算14年较09年的变动百分比
SELECT pls14.stabr,
