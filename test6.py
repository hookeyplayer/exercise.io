...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 12 16:18:41 2021
...
nx.draw(Gx, pos=nx.circular_layout(Gx), with_labels=True,
        ...
        width=edge_width)
plt.title("Корреляции цен активов (01.01.2016 -01.04.2018) Круговая схема, после удаления 99,64% (316017) рёбра с |корреляцией| < 0,5", fontdict=font_dict)
plt.show()

nx.draw(Gx, pos=nx.fruchterman_reingold_layout(Gx), with_labels=True,
        node_size=node_size, edge_color=edge_colours,
        width = edge_width)
plt.title("Корреляции цен активов (01.01.2016 -01.04.2018) - Fruchterman-Reingold, после удаления 99,64% (878590) рёбра с |корреляцией| < 0,5",
          fontdict=font_dict)
plt.show()
...
nx.draw(mst, with_labels=True, pos=nx.spectral_layout(mst),
        node_size=200, edge_color=edge_colours, width = 1.2)
plt.title("Корреляции цен активов (01.01.2016 -01.04.2018) - Минимальное остовное дерево",
          fontdict=font_dict)
plt.show()
#%%
# =============================================================================
...
plt.title("Распределение степеней узла (01.01.2016 -01.04.2018)",
          fontdict=font_dict)
plt.show()
